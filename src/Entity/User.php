...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Reclamation::class, cascade: ['remove'], orphanRemoval: true)]
    private Collection $reclamations;
    
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: SignAbstract::class, cascade: ['remove'], orphanRemoval: true)]
