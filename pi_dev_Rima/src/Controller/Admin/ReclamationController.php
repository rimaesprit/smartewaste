...
class ReclamationController extends AbstractController
{
    ...
    #[Route('/search', name: 'app_admin_reclamation_search', methods: ['GET'])]
    public function search(Request $request, ReclamationRepository $reclamationRepository): Response
    {
        ...
        $reclamations = $reclamationRepository->searchReclamationsAdmin(
            $query,
            $status,
            $type,
            $fromDate,
        ...
        // Si c'est une requête AJAX, renvoyer le contenu partiel
        if ($request->isXmlHttpRequest()) {
            return $this->render('admin/reclamation/_reclamations_list.html.twig', [
