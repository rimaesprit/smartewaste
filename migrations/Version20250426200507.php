 ...
 */
final class Version20250426200507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE conteneur (id INT AUTO_INCREMENT NOT NULL, type_dechet VARCHAR(255) NOT NULL, capacite DOUBLE PRECISION NOT NULL, poids_actuel DOUBLE PRECISION NOT NULL, emplacement VARCHAR(255) NOT NULL, zone VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE date_rec date_rec DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE etat_rec etat_rec VARCHAR(50) DEFAULT 'Pending' NOT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
